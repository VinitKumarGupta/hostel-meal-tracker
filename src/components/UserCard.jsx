  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-4 mb-4 sm:mb-0">
        <div className={`flex items-center justify-center h-12 w-12 rounded-2xl bg-gradient-to-br ${getAvatarGradient(name)} text-white font-bold text-sm shadow-md`}>
          {getInitials(name)}
        </div>
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">{totalMeals} total meals this month</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 sm:flex sm:items-center sm:space-x-4">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:space-x-1.5 bg-orange-50/50 sm:bg-transparent rounded-xl p-2 sm:p-0 text-center sm:text-left">
          ...
          <div>
            <div className="text-[10px] sm:hidden font-semibold text-orange-600">Breakfast</div>
            <div className="text-sm font-bold text-gray-800">
              {breakfast} <span className="text-xs font-normal text-gray-400 sm:inline hidden">breakfasts</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:space-x-1.5 bg-blue-50/50 sm:bg-transparent rounded-xl p-2 sm:p-0 text-center sm:text-left">
          ...
          <div>
            <div className="text-[10px] sm:hidden font-semibold text-blue-600">Lunch</div>
            <div className="text-sm font-bold text-gray-800">
              {lunch} <span className="text-xs font-normal text-gray-400 sm:inline hidden">lunches</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:space-x-1.5 bg-purple-50/50 sm:bg-transparent rounded-xl p-2 sm:p-0 text-center sm:text-left">
          ...
          <div>
            <div className="text-[10px] sm:hidden font-semibold text-purple-600">Dinner</div>
            <div className="text-sm font-bold text-gray-800">
              {dinner} <span className="text-xs font-normal text-gray-400 sm:inline hidden">dinners</span>
            </div>
          </div>
        </div>
      </div>
